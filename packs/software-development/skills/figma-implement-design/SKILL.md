...
<!--
This skill is part of a four-skill set ported from openai/skills .curated:
  - figma-implement-design     Figma -> Code (React/TS)
  - figma-generate-design      Code -> Figma (full screens, incremental)
  - figma-create-design-system-rules  project-level design rules authoring
  - figma-use                  mandatory prerequisite for use_figma calls

All four MUST be installed together. Cross-references between them use
relative paths and resolve when each skill lives in a sibling directory.
