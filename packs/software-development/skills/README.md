...
40 skills total: 12 managed workflow skills, 4 Figma skills, 24 design/dev
...
| Skill | When to use |
|-------|-------------|
| handover | Tired, context full, or at a milestone. Writes handover, spawns fresh agent via aia. |
